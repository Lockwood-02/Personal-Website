    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-600'>Software Development is something I am very passionate about. Creating applications that can help
                ...
                <p className='py-2 text-gray-600'>One of my interest in the computer science field is Front-End Development as well. I love 
